...
<div  class="form-group mb-4">
    ...
    <span class="text-danger product-title-error"></span>
</div>
...
<div  class="form-group mb-4">
    ...
    <span class="text-danger product-description-error"></span>
</div>

<div class="form-check form-switch mb-4">
    <input class="form-check-input" type="checkbox" role="switch" id="status" name="status" {{$product['status'] == 1 ? 'checked' : ''}}>
